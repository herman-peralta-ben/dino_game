...
const PTERA_FRAMES = [
  Sprite(imagePath: "assets/images/ptera/ptera_1.png", imageHeight: 80, imageWidth: 92),
  Sprite(imagePath: "assets/images/ptera/ptera_2.png", imageHeight: 80, imageWidth: 92),
];
...
class Ptera extends GameObject {
  ...
  Rect getRect(Size screenSize, double runDistance) {
    return Rect.fromLTWH(
      ...
      4 / 7 * screenSize.height - PTERA_FRAMES[frame].imageHeight - worldLocation.dy,
  ...
  @override
  Widget render() {
    return Image.asset(PTERA_FRAMES[frame].imagePath, gaplessPlayback: true);
  }
